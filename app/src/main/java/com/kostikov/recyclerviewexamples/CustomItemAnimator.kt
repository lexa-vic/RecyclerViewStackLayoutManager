...
class AppearanceAnimation(viewHolder: RecyclerView.ViewHolder,
                          postLayoutInfo: RecyclerView.ItemAnimator.ItemHolderInfo,
                          onAnimationsEnd: (RecyclerView.ViewHolder) -> Unit) :
...
class DisappearanceAnimation(viewHolder: RecyclerView.ViewHolder,
...
class ChangeAnimation(viewHolder: RecyclerView.ViewHolder,
                      preLayoutInfo: RecyclerView.ItemAnimator.ItemHolderInfo,
                      postLayoutInfo: RecyclerView.ItemAnimator.ItemHolderInfo,
                      onAnimationsEnd: (RecyclerView.ViewHolder) -> Unit) :
        ViewAnimation(viewHolder, onAnimationsEnd) {
